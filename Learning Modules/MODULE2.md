...
- Printing a Session should show readable information, not a memory address
...
(You can compile and run multiple files together!)
...
If you see this output, your Session class is working correctly!
...
- [ ] Can create a Session and print it from PracticeTracker
...
- **toString**: Look for "override toString Java" examples
